package frc.robot.nerdyfiles.pixy;

import java.awt.Color;
import java.util.concurrent.TimeUnit;

import frc.robot.nerdyfiles.pixy.links.Link;
import frc.robot.nerdyfiles.pixy.links.SPILink;
...
public class Pixy2 {
	...
	public static Pixy2 createInstance(LinkType type) {
		...
		case SPI:
			link = new SPILink();
			break;
		//There used to be I2C and UART here, but they were unused and hence removed.
		//They were also untested by the author.
		//See original github repo for code if needed in the future.
		default:
			return null;
		}
		return new Pixy2(link);
